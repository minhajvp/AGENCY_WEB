        ...
        <>
            <div className='p-2 md:p-20 '>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-6'>
                    <div className='mt-5 md:mt-10 h-70 flex flex-col items-center justify-center p-2 md:p-10'>
                        <p className='text-xl text-gray-500 font-semibold antialiased'>Your website is not just your “online presence”—it is your sales engine, brand identity, and the first impression for your customers.
                        </p>
                    ...
                    <div className='mt-5 md:mt-10 md:h-70 h-100 flex flex-col gap-5 md:gap-3 items-start justify-center p-2 md:p-10'>
